...
# 4 "isa/rv32ui/and.S" 2



# 1 "isa/rv32ui/../rv64ui/and.S" 1
# See LICENSE for license details.
...
.section .text; .global _start; _start: li x1, 0; li x2, 0; li x3, 0; li x4, 0; li x5, 0; li x6, 0; li x7, 0; li x8, 0; li x9, 0; li x10, 0; li x11, 0; li x12, 0; li x13, 0; li x14, 0; li x15, 0; li x16, 0; li x17, 0; li x18, 0; li x19, 0; li x20, 0; li x21, 0; li x22, 0; li x23, 0; li x24, 0; li x25, 0; li x26, 0; li x27, 0; li x28, 0; li x29, 0; li x30, 0; li x31, 0;; li gp, 0;
  ...
  test_2: li gp, 2; li x1, ((0xff00ff00) & ((1 << (32 - 1) << 1) - 1)); li x2, ((0x0f0f0f0f) & ((1 << (32 - 1) << 1) - 1)); and x14, x1, x2;; li x7, ((0x0f000f00) & ((1 << (32 - 1) << 1) - 1)); bne x14, x7, fail;;
  test_3: li gp, 3; li x1, ((0x0ff00ff0) & ((1 << (32 - 1) << 1) - 1)); li x2, ((0xf0f0f0f0) & ((1 << (32 - 1) << 1) - 1)); and x14, x1, x2;; li x7, ((0x00f000f0) & ((1 << (32 - 1) << 1) - 1)); bne x14, x7, fail;;
  test_4: li gp, 4; li x1, ((0x00ff00ff) & ((1 << (32 - 1) << 1) - 1)); li x2, ((0x0f0f0f0f) & ((1 << (32 - 1) << 1) - 1)); and x14, x1, x2;; li x7, ((0x000f000f) & ((1 << (32 - 1) << 1) - 1)); bne x14, x7, fail;;
  test_5: li gp, 5; li x1, ((0xf00ff00f) & ((1 << (32 - 1) << 1) - 1)); li x2, ((0xf0f0f0f0) & ((1 << (32 - 1) << 1) - 1)); and x14, x1, x2;; li x7, ((0xf000f000) & ((1 << (32 - 1) << 1) - 1)); bne x14, x7, fail;;

  #-------------------------------------------------------------
  # Source/Destination tests
  #-------------------------------------------------------------

  test_6: li gp, 6; li x1, ((0xff00ff00) & ((1 << (32 - 1) << 1) - 1)); li x2, ((0x0f0f0f0f) & ((1 << (32 - 1) << 1) - 1)); and x1, x1, x2;; li x7, ((0x0f000f00) & ((1 << (32 - 1) << 1) - 1)); bne x1, x7, fail;;
  test_7: li gp, 7; li x1, ((0x0ff00ff0) & ((1 << (32 - 1) << 1) - 1)); li x2, ((0xf0f0f0f0) & ((1 << (32 - 1) << 1) - 1)); and x2, x1, x2;; li x7, ((0x00f000f0) & ((1 << (32 - 1) << 1) - 1)); bne x2, x7, fail;;
  test_8: li gp, 8; li x1, ((0xff00ff00) & ((1 << (32 - 1) << 1) - 1)); and x1, x1, x1;; li x7, ((0xff00ff00) & ((1 << (32 - 1) << 1) - 1)); bne x1, x7, fail;;
